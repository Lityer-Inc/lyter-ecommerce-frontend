...
export const CheckoutPage = ({ isCartOpen2, toggleMobileCart }) => {
  ...
  return (
    <main className={`fixed flex w-full h-full top-0 left-0 z-30 justify-center ${isCartOpen2 ? "" : "hidden"}`}>
      <div className=" absolute bg-black/20 w-full h-full" onClick={() => { toggleMobileCart(false) }} />
