...
<p className="sign-in-text">Sign In</p>
        ...
        <div className="fixed w-full z-10">
          {/* menu lg */}
          <div
            className={`md:flex justify-evenly text-white px-2 pt-[8px] pb-[4px] shadow transition-all duration-500 bg-[#F5F5F5] w-full relative z-10 items-center hidden ${
              isCategoriesOpen ? "top-[-200px] opacity-0" : "top-0 opacity-100"
            } `}
          >
            {menu.map((data, index) => (
